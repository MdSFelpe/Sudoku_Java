...
import ui.custom.button.Finishbutton;
import ui.custom.button.ResetButton;
import ui.custom.button.buttomCheckGameStatus;
...
public class MainScreen  {
    ...
    private void addFinishgameButton(JPanel mainPanel) {
        finishGameButton = new Finishbutton(e -> {
    ...
    private void addCheckGameStatusButton(JPanel mainPanel) {
        JButton checkGameStatusButton = new buttomCheckGameStatus(e -> {
            var hasErrors = boardService.hasErrors();
            var gameStatus = boardService.getStatus();
            var message = switch (gameStatus){
                case NON_STARTED -> "O jogo não foi iniciado";
                case INCOMPLETE -> "O jogo não foi iniciado";
